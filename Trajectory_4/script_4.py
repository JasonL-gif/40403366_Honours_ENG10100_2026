...
from Interpolation_4 import q2_pchip, q3_pchip, q5_pchip
...
if __name__ == "__main__":
        ...
        dataframe1.to_csv("Final_Results/csv_4/script_4_data_energy_power.csv")
        dataframe2.to_csv("Final_Results/csv_4/script_4_data_torque.csv")
        dataframe3.to_csv("Final_Results/csv_4/script_4_data_box.csv")
        dataframe4.to_csv("Final_Results/csv_4/script_4_data_position.csv")
        dataframe5.to_csv("Final_Results/csv_4/script_4_data_velocity.csv")
        dataframe6.to_csv("Final_Results/csv_4/script_4_data_acceleration.csv")
