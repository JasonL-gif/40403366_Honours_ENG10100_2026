...
data1 = pd.read_csv("Final_Results/csv_4/PCHIP_4/script_4_pchip_data_box.csv")

## BOX TRAJECTORY AND PE; TRAJECTORY 4 ##
plt.subplot(2, 2, 1)
plt.title("x_box-t; Trajectory 4 [PCHIP]")
plt.grid()
...
#---------#
plt.subplot(2, 2, 2)
plt.title("y_box-t; Trajectory 4 [PCHIP]")
plt.grid()
plt.axhline(0, 0, 1, color = (0, 0, 0, 1))      # Produces a horizontal line at q = 0.
...
#---------#
plt.subplot(2, 2, 3)
plt.title("z_box-t; Trajectory 4 [PCHIP]")
plt.grid()
plt.axhline(0, 0, 1, color = (0, 0, 0, 1))      # Produces a horizontal line at q = 0.
...
#---------#
plt.subplot(2, 2, 4)
plt.title("x-y; Trajectory 4 [PCHIP]")
plt.grid()
plt.axhline(0, 0, 1, color = (0, 0, 0, 1))      # Produces a horizontal line at q = 0.
...
plt.show()
#---------#
plt.title("Box Potential Energy; Trajectory 4 [PCHIP]")
plt.grid()
