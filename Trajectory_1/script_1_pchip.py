...
import time
from Interpolation_1 import t_interp, t_smooth, q1_linear, q2_linear, q3_linear, q4_linear, q5_linear, q6_linear, gripper1_linear, gripper2_linear
from Interpolation_1 import q1_pchip, q2_pchip, q3_pchip, q5_pchip, gripper1_pchip, gripper2_pchip
...
if __name__ == "__main__":
        ...
        dataframe1.to_csv("Results/csv_bin/csv_1/PCHIP_1/script_1_pchip_data_energy_power.csv")
        dataframe2.to_csv("Results/csv_bin/csv_1/PCHIP_1/script_1_pchip_data_torque.csv")
        dataframe3.to_csv("Results/csv_bin/csv_1/PCHIP_1/script_1_pchip_data_box.csv")
        dataframe4.to_csv("Results/csv_bin/csv_1/PCHIP_1/script_1_pchip_data_position.csv")
        dataframe5.to_csv("Results/csv_bin/csv_1/PCHIP_1/script_1_pchip_data_velocity.csv")
        dataframe6.to_csv("Results/csv_bin/csv_1/PCHIP_1/script_1_pchip_data_acceleration.csv")
        dataframe7.to_csv("Results/csv_bin/csv_1/PCHIP_1/script_1_pchip_data_smoothposition.csv")
