...
import time
from Interpolation_3 import t_smooth, t_interp, q1_linear, q2_linear, q3_linear, q4_linear, q5_linear, q6_linear, gripper1_linear, gripper2_linear
...
if __name__ == "__main__":
        ...
        dataframe1.to_csv("Results/csv_bin/csv_3/script_3_data_energy_power.csv")
        dataframe2.to_csv("Results/csv_bin/csv_3/script_3_data_torque.csv")
        dataframe3.to_csv("Results/csv_bin/csv_3/script_3_data_box.csv")
        dataframe4.to_csv("Results/csv_bin/csv_3/script_3_data_position.csv")
        dataframe5.to_csv("Results/csv_bin/csv_3/script_3_data_velocity.csv")
        dataframe6.to_csv("Results/csv_bin/csv_3/script_3_data_acceleration.csv")
